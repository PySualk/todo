...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.sualk.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.sualk.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, org.sualk.domain.AppUser.class.getName());
